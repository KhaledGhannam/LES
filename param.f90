...
integer,parameter::nx=288,ny=288,nz=144/nproc + 1
...
real(kind=rprec),parameter::L_x=5.0_rprec,L_y=5.0_rprec
real(kind=rprec),parameter::z_i=288._rprec, L_z=288._rprec/nproc
...
logical::canopy_forcing=.true.
logical::constant_Cd=.true.
...
real(kind=rprec),protected::inv_strength_co=0.004_rprec,dcodz_top=0.004_rprec
real(kind=rprec),protected :: q_init=1.00_rprec, co_init=1.0_rprec
real(kind=rprec) :: q_scale=100._rprec, co_scale=100._rprec
...
logical, parameter :: use_mean_p_force = .true. ! .not.inflow
...
namelist /param_nml/ q_scale, T_scale, co_scale, &
                     u_star, ug0, vg0, &
                     inv_strength, inv_strength_q, inv_strength_co, &
                     dTdz_top, dqdz_top, dcodz_top, &
                     T_init, q_init, co_init, &
                     coriolis_forcing, nsteps, dt_dim, &
                     c_count, p_count, ubc, damping_method, &
                     initu, initsc, inilag, &
                     canopy_forcing, constant_Cd 
