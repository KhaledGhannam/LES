...
LIBPATH = -L/ncrc/home1/Khaled.Ghannam/LES/softwares/fftw-2.1.5/lib
...
ifeq ($(FCOMP),ifort)
  ...
  #FFLAGS = -O3 -ipo
  FFLAGS = -O2
  FFLAGS += $(MODDIR) -dynamic -mcmodel=medium -heap-arrays 1000
  #FLAGS += $(MODDIR) -dynamic -mcmodel=medium
  #FFLAGS = -O3 -ip  -ftz
...
.depend: $(SRCS)
	mkdir -p $(OPATH) $(MPATH);
	/ncrc/home1/Khaled.Ghannam/LES/softwares/makedepf90-2.7.0/makedepf90 -r $(COMPSTR) -d $(OPATH) -o $(EXE) $(SRCS) > .depend
